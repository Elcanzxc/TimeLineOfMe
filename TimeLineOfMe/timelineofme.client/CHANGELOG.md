...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest timelineofme.client -- --template=react`.
- Создание файла проекта (`timelineofme.client.esproj`).
